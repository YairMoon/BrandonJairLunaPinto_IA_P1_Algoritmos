import random
# Importamos la biblioteca `random` para realizar selecciones aleatorias basadas en probabilidades.
...
def generar_oracion(gramatica, simbolo="S"): ## Definimos la función que generará una oración a partir de un símbolo inicial.
    """
    Genera una oración a partir de un símbolo inicial utilizando una gramática probabilística.
